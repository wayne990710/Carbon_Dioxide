...
def plot_multiple_co2_charts(datasets, output_filename="CO2_window.png"):
    """
    ...
    # 【本次修改重點】：鎖定 X 軸範圍為 0 到 30
    ax.set_xlim(0, 30)
    
    # 讓 X 軸每隔 5 分鐘顯示一個刻度 (0, 5, 10, 15, 20, 25, 30)
    ax.set_xticks(np.arange(0, 35, 5))

    plt.title("窗戶開關狀態與二氧化碳濃度關係圖", fontsize=32, pad=25)
...
if __name__ == "__main__":
    my_datasets = [
        ...
        {"file": "20260213_ClassBeginWithoutWindow.csv", "label": "2/13 開窗上課", "color": "#2ca02c"}
    ]
    
    plot_multiple_co2_charts(my_datasets, output_filename="CO2_window.png")